...
class Enemy {
    ...
    initStats() {
        ...
        // Type-specific stats - much slower for less hectic gameplay
        const typeStats = {
            rustyWalker: { hp: 30, damage: 3, speed: 0.5, behavior: 'walker' },
            sparkHopper: { hp: 20, damage: 2, speed: 1.2, behavior: 'hopper' },
            drillGrunt: { hp: 40, damage: 5, speed: 0.7, behavior: 'aggressive' },
            laserSentinel: { hp: 25, damage: 4, speed: 0.5, behavior: 'ranged' },
            shieldBearer: { hp: 50, damage: 3, speed: 0.5, behavior: 'defender' },
            bladeDancer: { hp: 30, damage: 6, speed: 1.5, behavior: 'combo' },
            rocketTrooper: { hp: 35, damage: 7, speed: 0.7, behavior: 'ranged' },
            stealthHunter: { hp: 25, damage: 6, speed: 1.2, behavior: 'stealth' },
            heavyCrusher: { hp: 80, damage: 8, speed: 0.3, behavior: 'tank' }
        };
